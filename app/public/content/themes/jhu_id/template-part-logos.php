...
<div class="logos" id="logos">
    <div class="logos-preview">
        <div class="logos-images">
            ...
            <img class="bloomberg" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/bloomberg.small.vertical.blue.500px.png" />
            <img class="carey" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/carey.small.vertical.blue.500px.png" />
            <img class="cty" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/cty.small.vertical.blue.500px.png" />
            <img class="education" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/education.small.vertical.blue.500px.png" />
            <img class="krieger" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/krieger.small.vertical.blue.500px.png" />
            <img class="libraries" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/libraries.small.vertical.blue.500px.png" />
            <img class="medicine" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/medicine.small.vertical.blue.500px.png" />
            <img class="nursing" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/nursing.small.vertical.blue.500px.png" />
            <img class="peabody-conservatory" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/peabody-conservatory.small.vertical.blue.500px.png" />
            <img class="peabody-institute" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/peabody-institute.small.vertical.blue.500px.png" />
            <img class="peabody-preparatory" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/peabody-preparatory.small.vertical.blue.500px.png" />
            <img class="press" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/press.small.vertical.blue.500px.png" />
            <img class="sais" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/sais.small.vertical.blue.500px.png" />
            <img class="sheridan-libraries" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/sheridan-libraries.small.vertical.blue.500px.png" />
            <img class="sheridan-museums" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/sheridan-museums.small.vertical.blue.500px.png" />
            <img class="whiting" src="http://web1.johnshopkins.edu/~assets/identity/images/download-preview/whiting.small.vertical.blue.500px.png" />
        </div><!-- /.logos-images -->
    </div>
    <h3>Download Your Logo Files and Guidelines</h3>
